...
gfsh -e "connect --locator=localhost[${GEODE_LOCATOR_PORT}]" -e "import gpdb --region=/export"

gfsh -e "connect --locator=localhost[${GEODE_LOCATOR_PORT}]" -e "query --query=\"select id.toString() as id, value from /export\""
